...
const AddDoctors = () => {
  ...
  const [expierence, setExpiernce] = useState('1 year')
  ...
  const onSubmitHandler= async(event)=>{
    ...
    try {
      ...
      formData.append('experience',expierence)
      ...
      <div className='bg-white  px-8 py-8  rounded  w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
          <div className='w-full lg:flex-1 flex flex-col gap-4'>
            ...
            <div className='flex-1 flex flex-col  gap-1'>
              <p>Expierence</p>
              <select onChange={(e)=>setExpiernce(e.target.value)} value={expierence}  className='border  rounded px-3 py-2' name="" id="">
